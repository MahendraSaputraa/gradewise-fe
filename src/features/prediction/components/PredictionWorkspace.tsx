  ...
  return (
    <section className="workspace-section" id="prediction-form">
      <div className="section-intro">
        ...
        <div>
          <h2>Mulai evaluasi</h2>
          <p>
            Lengkapi 19 indikator untuk menghasilkan estimasi nilai berbasis
            model.
          </p>
        </div>
      </div>
      <div className="workspace-card">
        ...
        <aside className="insight-panel">
          ...
          <blockquote>
            “Data memberi konteks. Pemahaman memberi arah.”
          </blockquote>
          <p>
            Gradewise mengolah pola akademik, lingkungan, dan kebiasaan menjadi
            estimasi performa yang lebih menyeluruh.
          </p>
          <div className="insight-visual" aria-hidden="true">
            ...
            <svg viewBox="0 0 260 100">
              <path d="M5 86 C 45 82, 55 68, 83 70 S 126 43, 153 48 S 191 20, 255 12" />
            </svg>
          </div>
